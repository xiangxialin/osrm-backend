...
{
  public:
    ::google::protobuf::internal::ExplicitlyConstructed<Cells> _instance;
...
void AddDescriptorsImpl()
{
    ...
    ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(descriptor, 295);
    ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile("cells.proto",
...
CellData::CellData() : ::google::protobuf::Message(), _internal_metadata_(NULL)
{
      ...
      _cached_size_(0)
{
    ...
    ::memcpy(&valueoffset_,
             ...
             static_cast<size_t>(reinterpret_cast<char *>(&destinationnodesnumber_) -
                 ...
                 sizeof(destinationnodesnumber_));
...
bool CellData::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream *input)
{
...
void CellData::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream *output) const
{
    ...
    if (cached_has_bits & 0x00000002u)
    {
        ::google::protobuf::internal::WireFormatLite::WriteUInt32(
            2, this->sourceboundaryoffset(), output);
    }
    ...
    {
        ::google::protobuf::internal::WireFormatLite::WriteUInt32(
            3, this->destinationboundaryoffset(), output);
    }
    ...
    {
        ::google::protobuf::internal::WireFormatLite::WriteUInt32(
            4, this->sourcenodesnumber(), output);
    }
    ...
    {
        ::google::protobuf::internal::WireFormatLite::WriteUInt32(
            5, this->destinationnodesnumber(), output);
    }
...
CellData::InternalSerializeWithCachedSizesToArray(bool deterministic,
                                                  ::google::protobuf::uint8 *target) const
{
    ...
    {
        target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
            2, this->sourceboundaryoffset(), target);
    }
    ...
    {
        target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
            3, this->destinationboundaryoffset(), target);
    }
    ...
    {
        target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
            4, this->sourcenodesnumber(), target);
    }
    ...
    {
        target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
            5, this->destinationnodesnumber(), target);
    }
...
size_t CellData::ByteSizeLong() const
{
    ...
    if (_has_bits_[0 / 32] & 31u)
    {
        ...
        {
            total_size +=
                1 + ::google::protobuf::internal::WireFormatLite::UInt32Size(this->valueoffset());
        }
...
void CellData::MergeFrom(const ::google::protobuf::Message &from)
{
    ...
    const CellData *source =
        ::google::protobuf::internal::DynamicCastToGenerated<const CellData>(&from);
    if (source == NULL)
    {
...
bool CellData::IsInitialized() const { return true; }
...
Cells::Cells() : ::google::protobuf::Message(), _internal_metadata_(NULL)
{
    if (GOOGLE_PREDICT_TRUE(this != internal_default_instance()))
    {
...
Cells::Cells(const Cells &from)
    : ::google::protobuf::Message(), _internal_metadata_(NULL), _has_bits_(from._has_bits_),
      _cached_size_(0), sourceboundary_(from.sourceboundary_),
      destinationboundary_(from.destinationboundary_), cells_(from.cells_),
...
void Cells::SharedCtor() { _cached_size_ = 0; }
...
bool Cells::MergePartialFromCodedStream(::google::protobuf::io::CodedInputStream *input)
{
#define DO_(EXPRESSION)                                                                            \
    if (!GOOGLE_PREDICT_TRUE(EXPRESSION))                                                          \
    goto failure
...
void Cells::SerializeWithCachedSizes(::google::protobuf::io::CodedOutputStream *output) const
{
    ...
    // repeated .pbmldc.CellData cells = 3;
    for (unsigned int i = 0, n = static_cast<unsigned int>(this->cells_size()); i < n; i++)
    {
    ...
    {
        ::google::protobuf::internal::WireFormatLite::WriteUInt64(4, this->leveloffset(i), output);
    }
...
::google::protobuf::uint8 *
Cells::InternalSerializeWithCachedSizesToArray(bool deterministic,
                                               ::google::protobuf::uint8 *target) const
{
    (void)deterministic; // Unused
    ...
    // repeated uint32 sourceBoundary = 1;
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
        1, this->sourceboundary_, target);

    // repeated uint32 destinationBoundary = 2;
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(
        2, this->destinationboundary_, target);
...
size_t Cells::ByteSizeLong() const
{
    ...
    {
        size_t data_size =
            ::google::protobuf::internal::WireFormatLite::UInt32Size(this->sourceboundary_);
        total_size += 1 * ::google::protobuf::internal::FromIntSize(this->sourceboundary_size());
    ...
    {
        size_t data_size =
            ::google::protobuf::internal::WireFormatLite::UInt32Size(this->destinationboundary_);
        total_size +=
            1 * ::google::protobuf::internal::FromIntSize(this->destinationboundary_size());
        total_size += data_size;
    }
    ...
    {
        size_t data_size =
            ::google::protobuf::internal::WireFormatLite::UInt64Size(this->leveloffset_);
        total_size += 1 * ::google::protobuf::internal::FromIntSize(this->leveloffset_size());
        total_size += data_size;
    }
...
void Cells::MergeFrom(const ::google::protobuf::Message &from)
{
    ...
    GOOGLE_DCHECK_NE(&from, this);
    const Cells *source = ::google::protobuf::internal::DynamicCastToGenerated<const Cells>(&from);
    if (source == NULL)
    {
...
bool Cells::IsInitialized() const { return true; }
