...
class MLDQueryGraphDefaultTypeInternal {
 public:
  ::google::protobuf::internal::ExplicitlyConstructed<MLDQueryGraph>
      _instance;
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&::pbmldg::_MLDQueryGraph_default_instance_),
};
...
EdgeData::EdgeData(const EdgeData& from)
  ...
  ::memcpy(&target_, &from.target_,
    ...
    reinterpret_cast<char*>(&target_)) + sizeof(turnid_));
...
::google::protobuf::uint8* EdgeData::InternalSerializeWithCachedSizesToArray(
  ...
  // optional uint32 TurnID = 2;
  if (cached_has_bits & 0x00000002u) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->turnid(), target);
  }
...
MLDQueryGraph::MLDQueryGraph(const MLDQueryGraph& from)
  : ::google::protobuf::Message(),
      ...
      nodes_(from.nodes_),
      edges_(from.edges_),
      isforward_(from.isforward_),
      isbackward_(from.isbackward_),
      nodeleveloffset_(from.nodeleveloffset_),
      nodeweights_(from.nodeweights_) {
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:pbmldg.MLDQueryGraph)
}

void MLDQueryGraph::SharedCtor() {
  _cached_size_ = 0;
}
...
bool MLDQueryGraph::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ::google::protobuf::uint32 tag;
...
void MLDQueryGraph::SerializeWithCachedSizes(
  ...
  for (int i = 0, n = this->isforward_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(
      3, this->isforward(i), output);
  }

  // repeated bool IsBackward = 4;
  for (int i = 0, n = this->isbackward_size(); i < n; i++) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(
      4, this->isbackward(i), output);
  }
...
::google::protobuf::uint8* MLDQueryGraph::InternalSerializeWithCachedSizesToArray(
    bool deterministic, ::google::protobuf::uint8* target) const {
  (void)deterministic; // Unused
  ...
  target = ::google::protobuf::internal::WireFormatLite::
    WriteUInt32ToArray(1, this->nodes_, target);
  ...
  // repeated bool IsForward = 3;
  target = ::google::protobuf::internal::WireFormatLite::
    WriteBoolToArray(3, this->isforward_, target);

  // repeated bool IsBackward = 4;
  target = ::google::protobuf::internal::WireFormatLite::
    WriteBoolToArray(4, this->isbackward_, target);

  // repeated uint32 nodeLevelOffset = 5;
  target = ::google::protobuf::internal::WireFormatLite::
    WriteUInt32ToArray(5, this->nodeleveloffset_, target);

  // repeated int32 nodeWeights = 6;
  target = ::google::protobuf::internal::WireFormatLite::
    WriteInt32ToArray(6, this->nodeweights_, target);
...
// @@protoc_insertion_point(message_byte_size_start:pbmldg.MLDQueryGraph)
  ...
  // repeated bool IsForward = 3;
  {
    ...
    total_size += 1 *
                  ::google::protobuf::internal::FromIntSize(this->isforward_size());
    total_size += data_size;
  }
  ...
  // repeated bool IsBackward = 4;
  {
    ...
    size_t data_size = 1UL * count;
    total_size += 1 *
                  ::google::protobuf::internal::FromIntSize(this->isbackward_size());
    total_size += data_size;
  }
  ...
  {
    size_t data_size = ::google::protobuf::internal::WireFormatLite::
      UInt32Size(this->nodeleveloffset_);
    total_size += 1 *
                  ::google::protobuf::internal::FromIntSize(this->nodeleveloffset_size());
    total_size += data_size;
  }
  ...
  {
    size_t data_size = ::google::protobuf::internal::WireFormatLite::
      Int32Size(this->nodeweights_);
    total_size += 1 *
                  ::google::protobuf::internal::FromIntSize(this->nodeweights_size());
    total_size += data_size;
  }
...
// @@protoc_insertion_point(generalized_merge_from_start:pbmldg.MLDQueryGraph)
  ...
  const MLDQueryGraph* source =
      ::google::protobuf::internal::DynamicCastToGenerated<const MLDQueryGraph>(
          &from);
  if (source == NULL) {
...
bool MLDQueryGraph::IsInitialized() const {
  return true;
}
