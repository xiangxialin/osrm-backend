# UNRELEASED
  - Changes from 5.16.0:
    ...
    - Internals
      - CHANGED: Update segregated intersection identification [#4845](https://github.com/Project-OSRM/osrm-backend/pull/4845) and [#4968](https://github.com/Project-OSRM/osrm-backend/pull/4968)
    - Documentation:
