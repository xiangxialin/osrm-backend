...
class ContiguousInternalMemoryDataFacadeBase : public BaseDataFacade
{
  ...
  public:
    ...
    virtual DurationsRangeT GetUncompressedForwardDurations(const EdgeID id) const override final
    {
        auto range = segment_data.GetForwardDurations(id);
        return range;
    }

    virtual DurationsRangeT GetUncompressedReverseDurations(const EdgeID id) const override final
    {
