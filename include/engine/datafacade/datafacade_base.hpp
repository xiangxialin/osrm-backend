...
class BaseDataFacade
{
  public:
    ...
    using NodesIDRangeT =
        boost::any_range<NodeID, boost::random_access_traversal_tag, NodeID, std::ptrdiff_t>;
    using WeightsRangeT = boost::
        any_range<SegmentWeight, boost::random_access_traversal_tag, SegmentWeight, std::ptrdiff_t>;
    using DurationsRangeT = boost::any_range<SegmentDuration,
                                             boost::random_access_traversal_tag,
                                             SegmentDuration,
                                             std::ptrdiff_t>;
    using DatasourceIDRangeT = boost::
        any_range<DatasourceID, boost::random_access_traversal_tag, DatasourceID, std::ptrdiff_t>;
